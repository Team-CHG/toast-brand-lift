...
const FeatureSections = () => {
  ...
  return <>
      ...
      <section className="pt-40 md:pt-48 pb-20 relative overflow-visible -mt-20 md:-mt-28" style={{ background: `url(${newsletterCelebrationBg}) top center / contain no-repeat, url(${pageBackgroundTexture}) center / cover` }}>
