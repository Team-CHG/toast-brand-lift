  ...
  if (state === "popup" && !hasShownPopup) {
    return (
      <div className="fixed inset-0 z-[100] bg-black/30 backdrop-blur-sm">
        <div className="fixed bottom-4 left-4 bg-card rounded-xl shadow-2xl w-72 p-4 animate-in slide-in-from-bottom-4 fade-in duration-300">
          <button
          ...
          <div className="space-y-1.5 mb-3 text-xs">
            ...
            <p className="text-foreground"><span className="font-semibold">1 point</span> per $1 spent</p>
