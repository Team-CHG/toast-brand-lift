  ...
  return (
    <div className="min-h-screen">
      <SEO 
        ...
        description="Download the Toast All Day app for exclusive deals, faster rewards, and seamless ordering. Available on iOS and Android."
        keywords="Toast All Day app, mobile app, download app, restaurant app, order online"
      />
      <Navigation />
      <SideDrawer />
      <Breadcrumbs />
