...
const ToastMtPleasant = () => {
  const location = {
    ...
    description: "Our Hungry Neck Boulevard location in Mt. Pleasant offers the full Toast! experience with ample seating and a family-friendly atmosphere. Conveniently located for residents of Mt. Pleasant and visitors exploring the East Cooper area.",
  };
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title={`${location.name} - Toast All Day | Mt. Pleasant Breakfast & Brunch`}
        description={`Visit ${location.name} at ${location.address}, ${location.city}. ${location.hours}. Award-winning breakfast and brunch in Mt. Pleasant.`}
        keywords="Toast Mt Pleasant, Hungry Neck breakfast, Mt Pleasant brunch, East Cooper restaurant"
      />
      <Navigation />
      <SideDrawer />
      <main>
