...
const ToastSummerville = () => {
  const location = {
    ...
    description: "Toast! Summerville brings our award-winning breakfast and brunch to the charming town of Summerville. Known as 'Flowertown in the Pines,' this location offers the perfect spot for a delicious meal in a welcoming atmosphere.",
  };
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title={`${location.name} - Toast All Day | Summerville Breakfast & Brunch`}
        description={`Visit ${location.name} at ${location.address}, ${location.city}. ${location.hours}. Award-winning breakfast in Summerville.`}
        keywords="Toast Summerville, Old Trolley Road breakfast, Summerville brunch, Flowertown restaurant"
      />
      <Navigation />
      <SideDrawer />
      <main>
