...
const ToastColeman = () => {
  const location = {
    ...
    description: "Toast! on Coleman brings our beloved breakfast and brunch experience to the Coleman Boulevard corridor in Mt. Pleasant. This location features a welcoming atmosphere perfect for families and friends gathering for a delicious meal.",
  };
  ...
  return (
    <div className="min-h-screen">
      <SEO 
        title={`${location.name} - Toast All Day | Mt. Pleasant Breakfast`}
        description={`Visit ${location.name} at ${location.address}, ${location.city}. ${location.hours}. Award-winning breakfast in Mt. Pleasant.`}
        keywords="Toast on Coleman, Mt Pleasant breakfast, Coleman Boulevard brunch, Mt Pleasant restaurant"
      />
      <Navigation />
      <SideDrawer />
      <main>
        ...
        {location.temporarilyClosed && (
          <section className="bg-destructive/10 border-b border-destructive/20 py-4">
            <div className="container mx-auto px-4 flex items-center justify-center gap-3">
              ...
              <p className="text-destructive font-semibold">This location is temporarily closed</p>
            </div>
          </section>
        )}
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-wrap gap-4">
                  <Button asChild size="lg" disabled={location.temporarilyClosed}>
