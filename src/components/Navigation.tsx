      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center justify-center flex-1 gap-6">
            ...
            <a href="/mothers-day-gift-cards" className="text-highlight hover:text-highlight/80 transition-colors font-semibold">Gift Cards</a>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-6 border-t border-accent/10 max-h-[calc(100vh-5rem)] overflow-y-auto">
            <div className="flex flex-col gap-4">
              ...
              <a href="/mothers-day-gift-cards" className="text-lg font-semibold text-highlight hover:text-highlight/80 transition-colors">Gift Cards</a>
