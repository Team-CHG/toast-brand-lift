...
const About = () => {
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-primary">
              About <span className="text-accent">Toast! All Day</span>
            </h1>
      ...
      <section className="py-16" aria-labelledby="story-heading">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <article className="prose prose-lg max-w-none bg-card/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
      ...
      {/* Awards & Recognition */}
      <section className="py-16" aria-labelledby="awards-heading">
        <div className="container mx-auto px-4">
          <h2 id="awards-heading" className="text-3xl font-bold text-center mb-12 text-primary">Awards & Recognition</h2>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center bg-card/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              <div className="w-16 h-16 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <Award className="h-8 w-8 text-accent" aria-hidden="true" />
              </div>
              <h3 className="text-xl font-bold mb-2 text-foreground">Top 25 Brunches</h3>
            ...
            <div className="text-center bg-card/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-bold mb-2 text-foreground">NY Times Featured</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center bg-card/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-bold mb-2 text-foreground">20 Years Strong</h3>
              <p className="text-muted-foreground">
      ...
      <section className="py-16" aria-labelledby="cta-heading">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center bg-card/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
            <h2 id="cta-heading" className="text-3xl font-bold mb-6 text-primary">Cheer With Us</h2>
            <p className="text-lg text-foreground mb-8">
