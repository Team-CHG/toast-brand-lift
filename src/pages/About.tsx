...
const About = () => {
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <article className="prose prose-lg max-w-none">
              <h2 id="story-heading" className="text-3xl font-bold mb-6">Who We Are</h2>
      ...
      {/* Awards & Recognition */}
      <section className="py-16 bg-secondary" aria-labelledby="awards-heading">
        <div className="container mx-auto px-4">
          <h2 id="awards-heading" className="text-3xl font-bold text-center mb-12">Awards & Recognition</h2>
      ...
      <section className="py-16" aria-labelledby="cta-heading">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 id="cta-heading" className="text-3xl font-bold mb-6">Cheer With Us</h2>
            <p className="text-lg text-muted-foreground mb-8">
